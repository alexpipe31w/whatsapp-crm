...
export type AdminAuditLogWhereInput = {
  ...
  logId?: Prisma.StringFilter<"AdminAuditLog"> | string
  ...
  details?: Prisma.JsonFilter<"AdminAuditLog">
...
export type AdminAuditLogScalarWhereWithAggregatesInput = {
  ...
  logId?: Prisma.StringWithAggregatesFilter<"AdminAuditLog"> | string
  ...
  details?: Prisma.JsonWithAggregatesFilter<"AdminAuditLog">
...
export type AdminAuditLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"logId" | "adminId" | "action" | "targetType" | "targetId" | "details" | "createdAt", ExtArgs["result"]["adminAuditLog"]>
...
export interface AdminAuditLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const adminAuditLogWithLogIdOnly = await prisma.adminAuditLog.findMany({ select: { logId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AdminAuditLogs and only return the `logId`
   * const adminAuditLogWithLogIdOnly = await prisma.adminAuditLog.createManyAndReturn({
   *   select: { logId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AdminAuditLogs and only return the `logId`
   * const adminAuditLogWithLogIdOnly = await prisma.adminAuditLog.updateManyAndReturn({
   *   select: { logId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AdminAuditLogFieldRefs {
  readonly logId: Prisma.FieldRef<"AdminAuditLog", 'String'>
